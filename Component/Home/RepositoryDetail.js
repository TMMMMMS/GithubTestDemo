...
export default class RepositoryDetail extends Component {
    ...
    static navigationOptions = ({ navigation, screenProps }) => ({
        title: navigation.state.params.item.item.item.full_name ? navigation.state.params.item.item.item.full_name : navigation.state.params.item.item.item.fullName,
